...
struct cfg_root : cfg::node
{
	struct node_core : cfg::node
	{
		...
		cfg::_bool lower_spu_priority{this, "Lower SPU thread priority", false, true};
	...
	struct node_video : cfg::node
	{
		...
		cfg::_bool vsync{this, "VSync" false, true};
		...
		cfg::_bool use_gpu_texture_scaling{this, "Use GPU texture scaling", false, true};
		...
		cfg::_bool multithreaded_rsx{this, "Multithreaded RSX", false, true};
		...
		cfg::_int<50, 800> resolution_scale_percent{this, "Resolution Scale", 100, true};
